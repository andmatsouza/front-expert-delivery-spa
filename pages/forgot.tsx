...
const Forgot: NextPage = () => {
  return (
    <>
      <PageHead title='Recuperar senha' description='Sistema de Delivery' keywords='delivery, entrega de comida' />
      ...
      <div className='h-screen flex flex-col lg:flex-row'>
        ...
        <div className='lg:basis-8/12 flex'>
          <div className='max-w-2xl w-4/5 m-auto'>
            ...
            <Button className='bg-indigo-200 w-full p-4 text-xl text-indigo-600'>Continuar</Button>
            <div className='block text-center p-6'>
              <Link href='/login'>
                <a className='mt-6 text-slate-600 mb-6 hover:text-slate-900'>Voltar para o login.</a>
              </Link>
            </div>            
          </div>
        </div>
