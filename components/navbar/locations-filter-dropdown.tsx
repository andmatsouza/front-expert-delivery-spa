...
import { IconTargetLocation, IconArrowTopDown } from "../icon-family";
    ...
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="flex justify-center items-center w-full">
          <IconTargetLocation size={24} color="#FACD5D" />
          {locationSelected}
          <div className='flex'>
      ...
      >
        <Menu.Items className="absolute left-0 w-72 mt-2 bg-gray-100 shadow rounded-lg overflow-hidden">
